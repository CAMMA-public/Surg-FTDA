...
def main():
    ...
    # Checkpoint path
    parser.add_argument('--checkpoint', default='/home/ubuntu/meddataset/meddatasetnew/model/model_text/nip3v2/noise0textv2/coco_prefix-009.pt')
    ...
    parser.add_argument('--data_path', type=str, default='/home/ubuntu/meddataset/meddatasetnew/val/embedding_text_v2/nips3/surgvlp_val_image_embedding_align_500_image_v2.pkl',
                        help='path to the pickled input data')
    parser.add_argument('--save_path_prefix', type=str, default='/home/ubuntu/meddataset/meddatasetnew/all_generate/val/nips3v2/inference_kmeans500v2',
