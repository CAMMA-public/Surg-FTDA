...
class ClipCocoDataset(Dataset):
    ...
    def __init__(self, data_path: str,  prefix_length: int, gpt2_type: str = "gpt2",
        ...
        for caption in self.captions: 
            ...
            #encoded_caption = self.tokenizer.encode(caption["text"]) + [self.tokenizer.eos_token_id]
            encoded_caption = self.tokenizer.encode(caption["text"]) + [self.tokenizer.eos_token_id] #change if you want train base on text or step
...
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='/home/ubuntu/meddataset/meddatasetnew/train_test/embedding_step/embedding_nipsv3_v2/embedding_text_train.pkl', help='path to clip embeddings of captions generated by the attached embeddings_generator script')
    ...
    parser.add_argument('--out_dir', default='/home/ubuntu/meddataset/meddatasetnew_backup/model/model_text/nip3/noise0text', help='path to output directory')
