...
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='/home/ubuntu/meddataset/meddatasetnew/train/embedding_text/clip/train_clip_text.pkl', help='path to clip embeddings of captions generated by the attached embeddings_generator script')
    ...
    parser.add_argument('--out_dir', default='/home/ubuntu/meddataset/meddatasetnew/model/model_clip/noise0image', help='path to output directory')
    ...
    parser.add_argument('--use_image_embedding_as_clipcap', dest='use_image_embedding_as_clipcap', action='store_true', default=True, help='use image embedding as ClipCap')
    args = parser.parse_args()
