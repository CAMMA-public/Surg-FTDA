...
def main():
    ...
    parser.add_argument('--checkpoint', default='/home/ubuntu/meddataset/cholec_process/model_phase/nips3/v2/clip/noise0text/coco_prefix-008.pt')
    ...
    parser.add_argument('--data_path', type=str, default='/home/ubuntu/meddataset/cholec_process/phase_test/embedding_clip/image_kmeans500.pkl',
                        help='pickled file containing text and embeddings')
    parser.add_argument('--save_path_prefix', type=str,
                        default='/home/ubuntu/meddataset/choelc_generate/phase_test/v3/kmeans500',
