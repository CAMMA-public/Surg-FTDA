...
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='/home/ubuntu/meddataset/cholec_process/triplet_train/v2/embedding/nips3_partial/embedding_image_train10.pkl', help='path to clip embeddings of captions generated by the attached embeddings_generator script')
    ...
    parser.add_argument('--out_dir', default='/home/ubuntu/meddataset/cholec_process/model_triplet/partial/10', help='path to output directory')
