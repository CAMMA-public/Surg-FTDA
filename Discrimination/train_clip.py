...
class ClipCocoDataset(Dataset):
    ...
    def __init__(self, data_path: str,  prefix_length: int, gpt2_type: str = "gpt2",
                 normalize_prefix=False, use_image_embedding_as_clipcap=True): #change
...
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data', default='/home/ubuntu/meddataset/cholec_process/triplet_train/v2/embedding/clip/triplet_text_train.pkl', help='path to clip embeddings of captions generated by the attached embeddings_generator script')
    ...
    parser.add_argument('--out_dir', default='/home/ubuntu/meddataset/cholec_process/model_triplet/v2/clip/noise0text', help='path to output directory')
    ...
    parser.add_argument('--use_image_embedding_as_clipcap', dest='use_image_embedding_as_clipcap', action='store_true', default=True, help='use image embedding as ClipCap')   ###change
    args = parser.parse_args()
