...
kagle_json = '/home/ubuntu/dataset_coco.json' 

new_json_train = '/home/ubuntu/post_processed_karpthy_coco/train.json'
new_json_test = '/home/ubuntu/post_processed_karpthy_coco/test.json'
new_json_val = '/home/ubuntu/post_processed_karpthy_coco/val.json'
...
def map_format_kaggle_to_clipcap():
    ...
    if DBG:
        ...
        with open('/home/ubuntu/data/annotations/captions_train2014.json.json') as f:
            ##修改为绝对路径？
